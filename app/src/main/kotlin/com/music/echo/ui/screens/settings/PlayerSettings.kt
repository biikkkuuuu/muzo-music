...
package com.biikkkuuuu.muzi.ui.screens.settings
...
import com.biikkkuuuu.muzi.constants.AudioQuality
...
import com.biikkkuuuu.muzi.constants.AutomixDebugOverlayKey
...
import com.biikkkuuuu.muzi.constants.DownloadOnWifiOnlyKey
import com.biikkkuuuu.muzi.constants.EnableGoogleCastKey
import com.biikkkuuuu.muzi.constants.HistoryDuration
import com.biikkkuuuu.muzi.constants.KeepScreenOn
...
import com.biikkkuuuu.muzi.constants.SeekExtraSeconds
...
import com.biikkkuuuu.muzi.constants.StopMusicOnTaskClearKey
import com.biikkkuuuu.muzi.constants.EnableExportAsMp3Key
...
import com.biikkkuuuu.muzi.ui.component.EnumDialog
...
highlightKey: String? = null) {
    ...
    val (audioLoudnessPreset, onAudioLoudnessPresetChange) = rememberEnumPreference(
        com.biikkkuuuu.muzi.constants.AudioLoudnessPresetKey,
        defaultValue = com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.NORMAL
    )
    var showLoudnessPresetDialog by remember { mutableStateOf(false) }

    val (spatialAudio, onSpatialAudioChange) = rememberPreference(
        com.biikkkuuuu.muzi.constants.SpatialAudioKey,
        defaultValue = false
    )
    ...
    val (dataSaverEnabled, onDataSaverEnabledChange) = rememberPreference(
        key = com.biikkkuuuu.muzi.constants.DataSaverEnabledKey,
        defaultValue = false
    )
    ...
    val (playbackEngine, onPlaybackEngineChange) = rememberEnumPreference(
        com.biikkkuuuu.muzi.constants.PlaybackEngineKey,
        defaultValue = com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO
    )

    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        com.biikkkuuuu.muzi.constants.DownloadQualityKey,
        defaultValue = com.biikkkuuuu.muzi.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = listOf(com.biikkkuuuu.muzi.constants.DownloadQuality.YOUTUBE),
            valueText = {
                when (it) {
                    com.biikkkuuuu.muzi.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    else -> ""
                }
            }
        )
    ...
    if (showLoudnessPresetDialog) {
        EnumDialog(
            ...
            values = listOf(
                com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.QUIET,
                com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.NORMAL,
                com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.LOUD,
                com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.AGGRESSIVE,
            ),
            valueText = {
                when (it) {
                    com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.QUIET -> stringResource(R.string.loudness_preset_quiet)
                    com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.NORMAL -> stringResource(R.string.loudness_preset_normal)
                    com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.LOUD -> stringResource(R.string.loudness_preset_loud)
                    com.biikkkuuuu.muzi.constants.AudioLoudnessPreset.AGGRESSIVE -> stringResource(R.string.loudness_preset_aggressive)
                }
            },
        )
    }
    ...
    if (showPlaybackEngineDialog) {
        EnumDialog(
            ...
            onSelect = {
                ...
                com.biikkkuuuu.muzi.utils.YTPlayerUtils.playbackEngine = it
                showPlaybackEngineDialog = false
            },
            title = "Playback Engine",
            current = playbackEngine,
            values = listOf(
                com.biikkkuuuu.muzi.constants.PlaybackEngine.POTOKEN,
                com.biikkkuuuu.muzi.constants.PlaybackEngine.BRAVEPIPE,
                com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO,
            ),
            valueText = {
                when (it) {
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.POTOKEN -> "PoToken (Recommended)"
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.BRAVEPIPE -> "BravePipe (NewPipe)"
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO -> "Auto (Try Both)"
                }
            },
            valueDescription = {
                when (it) {
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.POTOKEN -> "Uses WebView PoToken + CipherDeobfuscator. Most reliable and future-proof."
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.BRAVEPIPE -> "Uses NewPipe extractor for stream resolution. Lightweight but may break with YouTube updates."
                    com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO -> "Tries PoToken first, falls back to BravePipe if it fails."
                }
            }
        )
    }
