...
import com.biikkkuuuu.muzi.di.ApplicationScope
import com.biikkkuuuu.muzi.extensions.toEnum
import com.biikkkuuuu.muzi.extensions.toInetSocketAddress
import com.biikkkuuuu.muzi.utils.CrashHandler
import com.biikkkuuuu.muzi.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        com.biikkkuuuu.muzi.utils.cipher.CipherDeobfuscator.initialize(this)
        com.biikkkuuuu.muzi.utils.YTPlayerUtils.initialize()
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[com.biikkkuuuu.muzi.constants.PlaybackEngineKey]
        com.biikkkuuuu.muzi.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) com.biikkkuuuu.muzi.constants.PlaybackEngine.valueOf(engineName)
            else com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { com.biikkkuuuu.muzi.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        com.biikkkuuuu.muzi.utils.lastfm.LastFM.initialize(
