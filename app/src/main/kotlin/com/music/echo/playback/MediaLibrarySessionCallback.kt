...
import com.biikkkuuuu.muzi.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(com.biikkkuuuu.muzi.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun com.biikkkuuuu.muzi.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
