...
package com.biikkkuuuu.muzi.listentogether
...
import com.biikkkuuuu.muzi.constants.ListenTogetherAutoApprovalKey
import com.biikkkuuuu.muzi.constants.ListenTogetherIsHostKey
import com.biikkkuuuu.muzi.constants.ListenTogetherRoomCodeKey
import com.biikkkuuuu.muzi.constants.ListenTogetherServerUrlKey
import com.biikkkuuuu.muzi.constants.ListenTogetherSessionTimestampKey
import com.biikkkuuuu.muzi.constants.ListenTogetherSessionTokenKey
import com.biikkkuuuu.muzi.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.biikkkuuuu.muzi.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.biikkkuuuu.muzi.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.biikkkuuuu.muzi.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.biikkkuuuu.muzi.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.biikkkuuuu.muzi.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.biikkkuuuu.muzi.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
