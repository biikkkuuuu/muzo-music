...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "com.biikkkuuuu.muzi.MainActivityAlias")
        val static = ComponentName(context, "com.biikkkuuuu.muzi.MainActivityStatic")
        val legacy = ComponentName(context, "com.biikkkuuuu.muzi.MainActivityLegacy")
